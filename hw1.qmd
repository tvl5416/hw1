...
I can conclude that col_wise_scan likely performs faster than
row_wise_scan for large matrices, due to R's column-major order of
matrix storage, which allows more efficient memory access during
